...
public class TemporayMain extends Application{
	...
	public void start(Stage primaryStage) throws IOException {
		...
		temporaryLoader  = new FXMLLoader(getClass().getResource("/ReviewPage/Review/StartPage.fxml"));
		// 임시 로더 -> 임시 루트
		loader = new FXMLLoader(getClass().getResource("/ReviewPage/Review/ReviewPage.fxml"));
		// 메인 로더 -> 리뷰 페이지 루트
...
public void start(int rid, String uid) throws IOException {
		...
		// 앞서 말한 임시 메서드를 이용해서 임시루트를 할당해주고요
		reviewCon.TmporaryTestPageSetRoot(temporaryRoot, rid, uid);
		reviewCon.setRoot(root);

...
public class MinigameComponentImpl implements MinigameComponent {
	
	@Override
	public Arc getArc(double x, double y, double rx, double ry, double startAngle, double length, Color color) {
		Arc arc = new Arc();
		arc.setCenterX(x);
		arc.setCenterY(y);
		arc.setRadiusX(rx);
...
Label lbl = new Label(str);
	...
	@Override
	public Line getThreadLine(double startX, double startY, double endX, double endY) {
		Line line = new Line(startX, startY, endX, endY);

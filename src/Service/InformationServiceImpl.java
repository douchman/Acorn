...
public class InformationServiceImpl implements InformationService{
	...
	public void TopInformation(Parent form, String shopId, String userId) {
		...
		comserv.ShowLabel(form, "#TitleLbl", dbserv.selectDB(dbserv.InformationSQL(shopId), "shop_name").get(0));
		...
		ShowStar(shopId);
		comserv.ShowLabel(form, "#TitleAddressLbl", dbserv.selectDB(dbserv.InformationSQL(shopId), "shop_address1").get(0));
		comserv.ShowLabel(form, "#TitleAddressLbl2", dbserv.selectDB(dbserv.InformationSQL(shopId), "shop_address2").get(0));
		comserv.ShowLabel(form, "#TitleKindfoodLbl", dbserv.selectDB(dbserv.InformationSQL(shopId), "shop_kind").get(0));
		comserv.ShowLabel(form, "#TitleViewLbl", dbserv.selectDB(dbserv.InformationSQL(shopId), "shop_view").get(0));
	}

...
public class ReviewListServiceImpl implements ReviewListService{
	...
	public void UpdateReviewServ(Parent form, String userId, String reviewId) {
		String email = dbserv.selectDB(dbserv.EditSQL(reviewId), "substr(user_email, 1, instr(user_email,'@')-1)").get(0);
		comserv.ShowLabel(form, "#WriterNameLbl", dbserv.selectDB(dbserv.EditSQL(reviewId), "user_name").get(0)+"("+ email +")");
